            ...
            <tbody>
                <?php foreach ($cars as $car): ?>
                    <tr>
                        ...
                        <td>
                            <a href="editar_carro.php?id=<?= $car['id'] ?>" class="edit-btn">Editar</a>
                            <a href="remover_carro.php?id=<?= $car['id'] ?>" class="delete-btn" onclick="return confirm('Tem certeza que deseja remover este carro?')">Remover</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
